...
| SOLITUDE | PROUDSPIRE MANOR | JORDIS | 25,000 | 11,000 - 14,000 | 36,000 - 39,000 |
...
|     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- |
|     | BEDROOM FURNISHINGS | LIVING ROOM | ALCHEMY LABORATORY | ENCHANTING AREA | ENTRANCE HALL | CHILD'S BEDROOM\* | HOUSECARL'S QUARTERS |
...
|     |     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|     | BEDROOM FURNISHINGS | KITCHEN FURNISHINGS | LIVING ROOM | ALCHEMY LABORATORY | ENCHANTING AREA | ARMORY | CLEAN UP\* | CHILD'S BEDROOM\* | HOUSECARL'S QUARTERS |
...
With the Hearthfire add-on, it is possible to construct and furnish your very own house. Three unique plots of land are available to build a house on throughout Skyrim

|     |     |     |     |     |
| --- | --- | --- | --- | --- |
| LOCATION | NAME | COST | PURCHASED FROM | HOUSECARL |
| DAWNSTAR | HELJARCHEN HALL | 5,000 | JARL SKALD / JARL BRINA MERILIS | GREGOR |
| FALKREATH | LAKEVIEW MANOR | 5,000 | STEWARD IN JARL'S LONGHOUSE | RAYYA |
| MORTHAL | WINDSTAD MANOR | 5,000 | ASLFUR / PACTUR | VALDIMAR |
...
Shadowfoot Sanctum is a small player home located in the Ratway beneath Riften. The house can be bought from **Vekel the Man (Ragged Flagon Barkeeper).**

A hidden Ratway hideout featuring full smithing and crafting facilities, secret access to the Riften Docks, multiple shrines, and fully furnished living quarters including space for adopted children. The home includes a large Thieves Guild themed trophy room with extensive displays for Dragon Priest masks, Dragon Claws, Nightingale gear, Forgotten Vale paragons, Litany of Larceny items, and other iconic artifacts.
...
![](/image_2025-12-21_004238305.png)
